...
$(function(){
  ...
  $(document).on('click','#submit',function(){
    ...
    var radio = $('input:radio[name="activeOption"]:checked').val();
    var numberSale = $('#select option:selected') .val();
    var option = {
      'id' : 'modal_submit',
      'title':'提示',
      'content' : '<p class="submit_r">您的登记信息是：<br /><span>玩法：' + radio + '</span><span>投注机号：' + number + '</span><span>销售期号：' + numberSale + '</span><span>流水号：' + numberSerial + '</span><hr /><span class="red">恭喜您，已成功报名参加幸运大抽奖，如果您有其它彩票满足条件，可继续登记参与，中奖几率更大哦！</span></p>',
      'btn_close_title' : '关闭',
      'btn_save_title' : '确定'
    }
    Modal.modal(option);
